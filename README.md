...
***Note: This whole project wouldn't be possible if it wasnt' for [sslov](https://github.com/ssloy/tinyraytracer/). It makes no sense just to look at the code, copy it and paste it for the completion of the project. Happy Learning!***
